...
g++ -O3 -std=c++20  -march=native -ffast-math ale_test.cpp ../src/matrixProd_AVX.cpp  -mavx2 -std=c++20 -o ale_test
#g++ -O0 -std=c++20 ale2_test2.cpp   -mavx2 -std=c++20 -o ale2_test2
